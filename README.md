...
- **Aerial chopper tour** — board a helicopter (built from primitives, spinning rotors, banking into its turns, cast shadow) and ride a chase-cam over the basin while the storm floods it beneath you, each neighbourhood named as you sweep across it. **Auto-pilot** flies a smooth loop through the hotspots, or switch to **Fly it myself** and pilot it directly (W/S forward·back, A/D turn, ↑/↓ climb·descend). The most immersive way to see the flood.
