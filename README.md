...
- **Aerial chopper tour** — board a helicopter (built from primitives, spinning rotors, banking into its turns, cast shadow) and ride a chase-cam loop over the basin while the storm floods it beneath you, each neighbourhood named as you sweep across it. The most immersive way to see the flood.
